...
| **[Test data types](test_data_configuration.md)** | Suite type ids (`message`, `document`, …) | Fixture overview |
| **[Suite data model](data_model_v2.md)** | Types, run configs, cells, generators | Catalog / `config/library` |
