...
| Library | Write + read (µs) | Size (bytes) | Role | Group |
|---------|-------------------|--------------|------|-------|
| mojo-avro | 1.64 | 118 | Avro | fastest |
| EmberJson | 2.14 | 452 | JSON — EmberJson | slower |
| mojo-protobuf | 2.33 | 157 | Protocol Buffers | slower |
| mojo-cbor | 4.53 | 329 | CBOR | slower |
| mojo-json | 5.23 | 452 | JSON — mojo-json | slower |
| ehsanmok-json | 62.0 | 452 | JSON — ehsanmok/json | slower |
| mojo-toml | 76.0 | 489 | TOML | slower |
