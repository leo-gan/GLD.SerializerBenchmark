...
Registered counts (Overview SoT): C# **36** · Python **16** · Rust **15** · C **19** · JavaScript **19** (simdjson optional) · Go **12** · Java **12**.
...
- **Examples in suite:**  
  ...
  - **Java:** `jackson`, `gson`, `fastjson2`, `dsl-json`  
...
- **Examples in suite:**  
  ...
  - **Java:** `kryo`, `msgpack`, `jackson-cbor`, `jackson-smile`, `bson`  
