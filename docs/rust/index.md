...
| [dagr-frozen-packed](https://codeberg.org/mzaks/dagr) | Schema | generated `benchmark_v2` | **Direct** builder into a reused `DagrBuilder`; lazy reader → domain | adapted | `frozen`+`packed` node layout; same call path as `dagr` |
