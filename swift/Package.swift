...
let package = Package(
    ...
    dependencies: [
        ...
        // Dagr: generated by `dagr build` from schemas/v2/dagr/schema.py (local package).
        .package(name: "BenchmarkV2", path: "DagrGen"),
    ],
    targets: [
        .target(
            name: "CapnpBridge",
        ...
        .target(
            ...
            dependencies: [
                ...
                .product(name: "BenchmarkV2", package: "BenchmarkV2"),
            ],
