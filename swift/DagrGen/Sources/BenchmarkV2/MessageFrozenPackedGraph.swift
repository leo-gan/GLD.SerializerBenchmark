...
public enum MessageFrozenPackedGraph {
    ...
    public typealias MessageFrozenPackedGraphGraph = MessageArena
    ...
    //
    //   enum MyBrand {}
    //   let arena = MessageFrozenPackedGraph.Arena<MyBrand>()
    //
...
extension MessageFrozenPackedGraph.Arena {
    public func newMessage(f_bool: Bool? = nil, f_int32: Int32? = nil, f_int64: Int64? = nil, f_float64: Double? = nil, f_string: String? = nil, f_bool_2: Bool? = nil, f_int32_2: Int32? = nil, f_string_2: String? = nil) -> MessageFrozenPackedGraph.Message<MessageFrozenPackedGraph.Arena<Brand>> {
        let _idx: Int
        _idx = arenaOfMessage.count
        arenaOfMessage.append(MessageFrozenPackedGraph.MessageValues(f_bool: f_bool, f_int32: f_int32, f_int64: f_int64, f_float64: f_float64, f_string: f_string, f_bool_2: f_bool_2, f_int32_2: f_int32_2, f_string_2: f_string_2))
        let _packed = UInt64(_idx)
        return MessageFrozenPackedGraph.Message(__packed: _packed, __graph: self)
    }
}

extension MessageFrozenPackedGraph.Arena {
    public func adopt<S: MessageFrozenPackedGraph.MessageGraph>(_ src: MessageFrozenPackedGraph.Message<S>) throws -> MessageFrozenPackedGraph.Message<MessageFrozenPackedGraph.Arena<Brand>> {
        var _seen = Set<UInt64>()
        return try _adopt(src, &_seen)
    }
    func _adopt<S: MessageFrozenPackedGraph.MessageGraph>(_ src: MessageFrozenPackedGraph.Message<S>, _ _seen: inout Set<UInt64>) throws -> MessageFrozenPackedGraph.Message<MessageFrozenPackedGraph.Arena<Brand>> {
...
extension MessageFrozenPackedGraph.Message: CustomStringConvertible {
...
extension MessageFrozenPackedGraph.Message: Hashable {
...
extension MessageFrozenPackedGraph.Message: Equatable {
...
extension MessageFrozenPackedGraph.Message {
    public static func == <OtherArena: MessageFrozenPackedGraph.MessageGraph>(lhs: Self, rhs: MessageFrozenPackedGraph.Message<OtherArena>) -> Bool {
        var visited = Set<ArenaPair>()
    ...
    func cycleAwareEqualsAny<OtherArena: MessageFrozenPackedGraph.MessageGraph>(
        other: MessageFrozenPackedGraph.Message<OtherArena>,
...
extension MessageFrozenPackedGraph.Message: ArenaNodeHandle {}
extension MessageFrozenPackedGraph.Message: ArenaGraphStorable {
...
extension MessageFrozenPackedGraph.Arena {
    ...
    public static func restore(from data: Foundation.Data) throws -> MessageFrozenPackedGraph.Arena<Brand> {
        guard !data.isEmpty else { return MessageFrozenPackedGraph.Arena<Brand>() }
        let arena = MessageFrozenPackedGraph.Arena<Brand>()
    ...
    private func _restoreMessage(from data: Foundation.Data, at start: Int, cache: inout [Int: Int]) throws -> MessageFrozenPackedGraph.Message<MessageFrozenPackedGraph.Arena<Brand>> {
        if let idx = cache[start] { return MessageFrozenPackedGraph.Message(__packed: UInt64(idx), __graph: self) }
        let idx = arenaOfMessage.count
        cache[start] = idx
        arenaOfMessage.append(MessageFrozenPackedGraph.MessageValues())
        var values = MessageFrozenPackedGraph.MessageValues()
        ...
        return MessageFrozenPackedGraph.Message(__packed: UInt64(idx), __graph: self)
    }
