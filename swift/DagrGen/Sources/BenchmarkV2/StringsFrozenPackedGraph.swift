...
public enum StringsFrozenPackedGraph {
    ...
    public typealias StringsFrozenPackedGraphGraph = StringsArena
    ...
    //
    //   enum MyBrand {}
    //   let arena = StringsFrozenPackedGraph.Arena<MyBrand>()
    //
...
extension StringsFrozenPackedGraph.Arena {
    public func newStrings(items: [String] = []) -> StringsFrozenPackedGraph.Strings<StringsFrozenPackedGraph.Arena<Brand>> {
        let _idx: Int
        _idx = arenaOfStrings.count
        arenaOfStrings.append(StringsFrozenPackedGraph.StringsValues(items: items))
        let _packed = UInt64(_idx)
        return StringsFrozenPackedGraph.Strings(__packed: _packed, __graph: self)
    }
}

extension StringsFrozenPackedGraph.Arena {
    public func adopt<S: StringsFrozenPackedGraph.StringsGraph>(_ src: StringsFrozenPackedGraph.Strings<S>) throws -> StringsFrozenPackedGraph.Strings<StringsFrozenPackedGraph.Arena<Brand>> {
        var _seen = Set<UInt64>()
        return try _adopt(src, &_seen)
    }
    func _adopt<S: StringsFrozenPackedGraph.StringsGraph>(_ src: StringsFrozenPackedGraph.Strings<S>, _ _seen: inout Set<UInt64>) throws -> StringsFrozenPackedGraph.Strings<StringsFrozenPackedGraph.Arena<Brand>> {
...
extension StringsFrozenPackedGraph.Strings: CustomStringConvertible {
...
extension StringsFrozenPackedGraph.Strings: Hashable {
...
extension StringsFrozenPackedGraph.Strings: Equatable {
...
extension StringsFrozenPackedGraph.Strings {
    public static func == <OtherArena: StringsFrozenPackedGraph.StringsGraph>(lhs: Self, rhs: StringsFrozenPackedGraph.Strings<OtherArena>) -> Bool {
        var visited = Set<ArenaPair>()
    ...
    func cycleAwareEqualsAny<OtherArena: StringsFrozenPackedGraph.StringsGraph>(
        other: StringsFrozenPackedGraph.Strings<OtherArena>,
...
extension StringsFrozenPackedGraph.Strings: ArenaNodeHandle {}
extension StringsFrozenPackedGraph.Strings: ArenaGraphStorable {
...
extension StringsFrozenPackedGraph.Arena {
    ...
    public static func restore(from data: Foundation.Data) throws -> StringsFrozenPackedGraph.Arena<Brand> {
        guard !data.isEmpty else { return StringsFrozenPackedGraph.Arena<Brand>() }
        let arena = StringsFrozenPackedGraph.Arena<Brand>()
    ...
    private func _restoreStrings(from data: Foundation.Data, at start: Int, cache: inout [Int: Int]) throws -> StringsFrozenPackedGraph.Strings<StringsFrozenPackedGraph.Arena<Brand>> {
        if let idx = cache[start] { return StringsFrozenPackedGraph.Strings(__packed: UInt64(idx), __graph: self) }
        let idx = arenaOfStrings.count
        cache[start] = idx
        arenaOfStrings.append(StringsFrozenPackedGraph.StringsValues())
        var values = StringsFrozenPackedGraph.StringsValues()
        ...
        return StringsFrozenPackedGraph.Strings(__packed: UInt64(idx), __graph: self)
    }
...
extension StringsFrozenPackedGraph {
    public enum Direct {
