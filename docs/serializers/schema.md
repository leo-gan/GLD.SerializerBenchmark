...
> **Concepts page.** Bond Fast/Compact/Json **are** in the C# harness; Rust `prost-wire` is an envelope stand-in (see Rust caveats). What we measure: [serialization categories](../analysis/serialization_categories.md) and each `docs/<lang>/index.md`.
