...
| Path | Role |
|------|------|
| [`js/`](js/) | Node snippets for API/JSON mental models (101/201 flavor) |
| [`go/`](go/) | MiniUser golden vectors G1–G5 (401 homework) |
| [`rust/`](rust/) | MiniUser golden vectors G1–G5 (401 homework) |
