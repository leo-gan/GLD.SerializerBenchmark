...
INCLUDE=(-I src -I vendor/cbor_src -I vendor/pb_src -I vendor/toml_src -I vendor/ehsanmok_src -I vendor/gldjson_src -I vendor/yaml_src -I vendor/msgpack_src -I vendor/fb_src)
export LOG_DIR
ARGS=("$REPS")
