#!/usr/bin/env python3
"""Build the shared Experiment 14 record from experiment.yaml.

Writes sample.json next to experiment.yaml (one file for every language).

    cd analysis
    uv run python ../experiments/14-starter-kit/python/save_sample.py
"""
...
def main() -> int:
    ...
    payload = {
        "about": (
            "This is the shared Experiment 14 record (one order-like value). "
        ...
        "experiment": cfg["id"],
        "config": "experiments/14-starter-kit/experiment.yaml",
