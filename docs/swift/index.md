...
| [dagr-packed](https://codeberg.org/mzaks/dagr) | Schema | generated (`swift/DagrGen`, `dagr build`) | adapted | Packed nodes; generated direct builder → reused `DataArenaBuilder`; lazy reader → domain (timed). N>1 framed by the wrapper (u32 count + (u32 len + buffer)×N) |
...
| [dagr-frozen-packed](https://codeberg.org/mzaks/dagr) | Schema | generated (`swift/DagrGen`, `dagr build`) | adapted | Frozen+packed nodes, `<T>FrozenPackedGraph`; same call path as dagr-packed (direct builder) |
