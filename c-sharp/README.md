...
- `benchmark-log.csv`: Performance metrics.
...
For a deeper dive into the results, open `src/Analysis.ipynb` using Jupyter or the VS Code Interactive window.

### Documentation
- **[Serializer Reference](../docs/c-sharp/c-sharp_tested_serializers.md)**: Detailed descriptions of all 38 serializers, their capabilities, and limitations.
- **[Result Explanations](src/Docs/ResultExplanations.md)**: Understanding the test reports, measurement modes, and execution workflow.
- **[Short Analysis]("src/Docs/BenchmarkAnalysis.Gemini%20Export%20April%2021,%202026%20at%208_50_00 p.m.%20UTC-7.pdf")**: Autogenerated benchmark analysis.
