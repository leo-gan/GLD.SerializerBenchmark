#!/usr/bin/env python3
"""Build the shared Experiment 1 record from experiment.yaml.
...
def main() -> int:
    ...
    payload = {
        "about": (
            "This is the shared Experiment 1 record (one order-like value). "
        ...
        "experiment": cfg["id"],
        "config": "experiments/01-json-library-bakeoff/experiment.yaml",
